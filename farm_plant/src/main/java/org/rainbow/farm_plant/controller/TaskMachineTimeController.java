...
import org.rainbow.farm_plant.entity.TaskMachineTime;
import org.rainbow.farm_plant.service.TaskMachineTimeService;
...
public class TaskMachineTimeController {
    ...
    public BaseResult<TaskMachineTime> getTaskMachineTimeById(@RequestParam("id") Long id){
        ...
        return BaseResult.success(taskMachineTime);
    }
