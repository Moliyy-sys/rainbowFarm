...
import org.rainbow.farm_plant.entity.TaskMaterialTime;
import org.rainbow.farm_plant.service.TaskMaterialTimeService;
...
public class TaskMaterialTimeController {
    ...
    public BaseResult<TaskMaterialTime> getTaskMaterialTimeById(@RequestParam("id") Long id){
        ...
        return BaseResult.success(taskMaterialTime);
    }
