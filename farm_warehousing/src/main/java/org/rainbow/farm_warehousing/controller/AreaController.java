...
import org.rainbow.farm_warehousing.entity.Area;
import org.rainbow.farm_warehousing.service.AreaService;
...
public class AreaController {
    ...
    public BaseResult<IPage<Area>> getAreaList(
        ...
        return BaseResult.success(areaPage);
    }
    ...
    public BaseResult<Area> findById(@RequestParam("id") Long id) {
        ...
        return BaseResult.success(area);
    }
