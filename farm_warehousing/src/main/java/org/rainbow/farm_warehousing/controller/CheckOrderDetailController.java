...
import org.rainbow.farm_warehousing.entity.CheckOrderDetail;
import org.rainbow.farm_warehousing.service.CheckOrderDetailService;
...
public class CheckOrderDetailController {
    ...
    public BaseResult<IPage<CheckOrderDetail>> list(
        ...
        return BaseResult.success(checkOrderDetailIPage);
    }
    ...
    public BaseResult<CheckOrderDetail> getCheckOrderDetailById(@RequestParam Long id){
        ...
        return BaseResult.success(checkOrderDetail);
    }
