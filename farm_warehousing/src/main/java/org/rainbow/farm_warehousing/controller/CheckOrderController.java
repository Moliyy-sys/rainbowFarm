package org.rainbow.farm_warehousing.controller;

import com.baomidou.mybatisplus.core.metadata.IPage;
import org.rainbow.farm_common.result.BaseResult;
import org.rainbow.farm_warehousing.entity.CheckOrder;
import org.rainbow.farm_warehousing.service.CheckOrderService;
...
public class CheckOrderController {
    ...
    public BaseResult<IPage<CheckOrder>> list(
        ...
        return BaseResult.success(checkOrderIPage);
    }
    ...
    public BaseResult<CheckOrder> getCheckOrderById(@RequestParam Long id){
        ...
        return BaseResult.success(checkOrder);
    }
    ...
    public BaseResult<String> addCheckOrder(@RequestBody CheckOrder checkOrder){
        ...
        return BaseResult.success(checkOrderNo);
    }
